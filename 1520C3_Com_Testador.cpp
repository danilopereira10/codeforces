...
int main() {
    ...
    for (int k = 3; k <= n; k++) {
        ...
        if (k % 2 == 0) {
            for (int i = 50 - k / 2; i < k + 50 - k/2; i++) {
                int j;
                for (j = 50 - k / 2; j < k - 1 + 50 - k/2; j++) {
                    b[a[i][j]]++;
                    cout << a[i][j] << " ";
                }
                b[a[i][j]]++;
                cout << a[i][k - 1 + 50 - k/2] EN;
            }

        } else {
            for (int i = 50 - k / 2; i < k + 50 -k/2; i++) {
                int j;
                for (j = 49 - k / 2; j < k - 1 + 49 -k/2; j++) {
                    cout << a[i][j] << " ";
                    b[a[i][j]]++;
                }
                b[a[i][j]]++;
                cout << a[i][k - 1 + 49 -k/2] EN;
            }
