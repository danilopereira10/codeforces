...
int main() {
    ...
    for (int i = 0; i < t; i++) {
        ...
        priority_queue <tuple<int,list<int>::iterator>, vector<tuple<int,list<int>::iterator>>, greater<tuple<int, list<int>::iterator>>> pq;
        list<int>::iterator b = a.begin();
        if (a.size() > 2) {
            b++;
            while (b != a.end()--) {
                pq.push(make_tuple(*b, b));
                b++;
            }
        }
        ...
        ll d = 0;
        while (a.size() > 2) {
            list<int>::iterator c = a.begin();
            list<int>::iterator c2 = a.end();
            tuple<int, list<int>::iterator> c3 = pq.top();
            if (get<0>(c3) <= (*(c) + *(c2))) {
                d += get<0>(c3);
                int & c4(*(get<1>(c3)));
                c4 += *(get<1>(c3)--);
                ...
                pq.erase(find(pq.c.begin(), pq.c.end(), make_tuple(*(get<1>(c3)--),get<1>(c3)--)));
                pq.pop();
                a.erase(get<1>(c3));
            } else {
                list<int>
        ...
        a.push_back(make_tuple(d,b,c));
        if (a.size() > 2) {
            list<tuple<int, list<int>::iterator, list<int>::iterator>>::iterator e;
